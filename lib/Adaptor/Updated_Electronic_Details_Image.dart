...
class UpdatedElectronicImageSubmit {
  Future UpdatedElectronicuploadData(
      List images,
    ...
    String URL =
        "https://onclickproperty.com//Onclick_API/Update_Electronic_details.php";
    ...
    request.fields["preimg"] = previousimage;
    request.fields["electronicid"] = electronicid;
