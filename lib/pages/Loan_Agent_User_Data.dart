...
import 'package:onclickproperty/Adaptor/Insert_Contact_To_Bank_Details.dart';
import 'package:onclickproperty/Adaptor/Insert_Loan_Agent_User_Data.dart';
...
class LoanAgentUserDataPage extends StatefulWidget {
  @override
  //String checkid;
  String AgentId;
  //String mobileno;
  LoanAgentUserDataPage(this.AgentId);
  _LoanAgentUserDataPageState createState() =>
      _LoanAgentUserDataPageState(this.AgentId);
}

class _LoanAgentUserDataPageState extends State<LoanAgentUserDataPage> {
  //String checkid;
  String AgentId;
  //String mobileno;
  _LoanAgentUserDataPageState(this.AgentId);
...
//    If all data are correct then save data to out variables
      ...
      _getLoanAgentData(
          ...
          _selectdate,
          Occupation != null ? Occupation.toString() : "",
          Income != null ? Income.toString() : "",
          LoanType != null ? LoanType.toString() : "",
  ...
  Future<String> _getLoanAgentData(
      String actionId,
      String AgentID,
      String full_Name,
      String Email_ID,
    ...
    try {
      InsertLoanAgentUserData LoanUserData = new InsertLoanAgentUserData();
      var LoanAgentUserData = await LoanUserData.getInsertLoanAgentUserData(
          actionId,
          AgentID,
          full_Name,
          Email_ID,
          ...
          lat,
          long);
      if (LoanAgentUserData != null) {
        print("LoanAgentUser Data///${LoanAgentUserData}");
        var resid = LoanAgentUserData['resid'];
        ...
        if (resid == 200) {
          ...
          _Emailtext.clear();
          _Mobiletext.clear();
          _Occupationtext.clear();
          _Incometext.clear();
          _Locationtext.clear();
          _AlternateMobiletext.clear();
          _Stdtext.clear();
          _telephonetext.clear();

          Navigator.of(context).push(
            MaterialPageRoute(builder: (_) {
              return ViewLoanAgentDetailsPage(widget.AgentId,"1");
            }),
          );
