...
class UserPostedResidentalTab extends StatefulWidget {
  @override
  _UserPostedResidentalTabState createState() => _UserPostedResidentalTabState();
}

class _UserPostedResidentalTabState extends State<UserPostedResidentalTab> {
  @override
        ...
        child: Column(
            ...
            children: <Widget>[
                      ...
                      Container(
                        child: Material(
                          ...
                          child: TabBar(
                            ...
                            tabs: [
                              Tab(text: 'Sell [${Userpostedcountlist[0].ResidentalBuyCount}]'),
                              Tab(text: 'Rent [${Userpostedcountlist[0].ResidentalRentCount}]'),
                            ],
                          ),
                        ),
                      ),
              ...
              Container(
                  ...
                  child: TabBarView(
                    children: <Widget>[
                      UserPostedCommonPropertyTabtabScreen(1,"Buy"),
                      UserPostedCommonPropertyTabtabScreen(1,"Rent"),
                    ],
                  )),
            ]));
  }
