...
import 'package:onclickproperty/pages/Getting_User_Electronic_Data_Page.dart';
...
import 'package:onclickproperty/pages/Property_User_Data.dart';
...
class OtpownerForm extends StatefulWidget {
  // const OtpForm({
  //   Key key,
  // }) : super(key: key);
  Function setLoading;
  ...
  OtpownerForm(this.setLoading, this.otpno, this.mobileNo, this.visTimershow,
      this.CheckId, this.ID);

  @override
  _OtpFormState createState() => _OtpFormState(this.setLoading, this.otpno,
      this.mobileNo, this.visTimershow, this.CheckId, this.ID);
}

class _OtpFormState extends State<OtpownerForm> {
  Function setLoading;
  String CheckId;
  String otpno;
  final String mobileNo;
                ...
                if (sPassword1.isNotEmpty ||
                  ...
                  if (otpno == megerOtp) {
                    if (CheckId == "1") {
                      ...
                      //     return GettingUserDataPage(CheckId,ID,mobileNo);
                      //   }),
                      // );
                    } else if (CheckId == "2") {
                      // Navigator.of(context).push(
                      //   MaterialPageRoute(builder: (_) {
                      //     return GettingUserElectronicDataPage(CheckId,ID,mobileNo);
                      //   }),
                      // );
                    }
                    // else if (CheckId == "3") {
                    //   Navigator.of(context).push(
                    //     MaterialPageRoute(builder: (_) {
                    //       return LoanAgentUserDataPage(CheckId,ID,mobileNo);
                    //     }),
                    //   );
                    // }
                    // else if (CheckId == "4") {
                    //   Navigator.of(context).push(
                    //     MaterialPageRoute(builder: (_) {
                    //       return RentalAgentUserDataPage(CheckId,ID,mobileNo);
                    //     }),
                    //   );
                    // }
                    // else if (CheckId == "5") {
                    //   Navigator.of(context).push(
                    //     MaterialPageRoute(builder: (_) {
                    //       return HomeServiceUserDataPage(CheckId,ID,mobileNo);
                    //     }),
                    //   );
                    // }
                    else if (CheckId == "6") {
                      // Navigator.of(context).push(
                      //   MaterialPageRoute(builder: (_) {
                      //     return PropertyUserDataPage(CheckId,ID,mobileNo);
                      //   }),
                      // );
                    }
                  } else {
