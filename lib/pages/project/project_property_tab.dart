...
class ProjectPropertyTab extends StatefulWidget {
  Function setLoading;
  final String localityName;

  ProjectPropertyTab(this.setLoading, this.localityName);

  @override
  _ProjectPropertyTabState createState() =>
      _ProjectPropertyTabState(this.setLoading, this.localityName);
}

class _ProjectPropertyTabState extends State<ProjectPropertyTab> {
  Function setLoading;
  final String localityName;
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Image(
                                    image:
                                        AssetImage("assets/images/village.png"),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        "We are Showing You Top Project Collections",
                        style: TextStyle(
                    ...
                    Consumer<AllDashboardProjectTopProperty>(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(top: 5.0),
                      child: Text(
                        "We are Showing You Top Sell Project Collections",
                        style: TextStyle(
                          fontSize: getProportionateScreenWidth(12),
                          fontWeight: FontWeight.normal,
                        ),
                    ...
                    Consumer<AllDashboardProjectSellProperty>(
