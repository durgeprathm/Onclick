...
class Body extends StatefulWidget {
  Body(this.mobileNo, this.otpNo, this.setLoading);
  ...
  _BodyState createState() =>
      _BodyState(this.mobileNo, this.otpNo, this.setLoading);
}
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                OtpForm(_getLoading, _getOtpNo.toString(), mobileNo.toString(),
                    _getVisForTimer),
