...
import 'package:onclickproperty/pages/UpdateDetais_Rental_Agent_Page.dart';
...
class ViewRentDetailsPage extends StatefulWidget {
  @override
  String Rentalagentid;
  String Checkid;
  ViewRentDetailsPage(this.Rentalagentid, this.Checkid);
  _ViewRentDetailsPageState createState() => _ViewRentDetailsPageState();
}

class _ViewRentDetailsPageState extends State<ViewRentDetailsPage> {
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "${FetchupdatedAgentslist[0].Description != null ? FetchupdatedAgentslist[0].Description : ''}",
                                style: TextStyle(
                                  fontSize: getProportionateScreenWidth(12),
                                  color: Colors.black,
                                ),
                              ...
                              Text(
                                "${FetchupdatedAgentslist[0].category != null ? FetchupdatedAgentslist[0].category : ''}",
                                style: TextStyle(
                                  fontSize: getProportionateScreenWidth(12),
                                  color: Colors.black,
                                ),
                              ...
                              Text(
                                "${FetchupdatedAgentslist[0].registertype != null ? FetchupdatedAgentslist[0].registertype : ''}",
                                style: TextStyle(
                                  fontSize: getProportionateScreenWidth(12),
                                  color: Colors.black,
                                ),
                              ...
                              SizedBox(height: SizeConfig.screenHeight * 0.03),
                              Text(
                                "Provide Service To Customer Location",
                                style: TextStyle(
                                  fontSize: getProportionateScreenWidth(15),
                                  fontWeight: FontWeight.bold,
                                  color: Colors.black,
                              ...
                              //     }),
                              Text(
                                "${FetchupdatedAgentslist[0].provdcustomrlocat != null ? FetchupdatedAgentslist[0].provdcustomrlocat : ''}",
                                style: TextStyle(
                                  fontSize: getProportionateScreenWidth(12),
                                  color: Colors.black,
                                ),
                              ...
                              //           Navigator.of(context).push(
                              //             MaterialPageRoute(builder: (_) {
                              //               return UpdatedRentalAgentDetails();
                              //             }),
                              //           );
                              //         },
                              //         child: Text(
  ...
  @override
  void initState() {
    _getservicesdata(widget.Rentalagentid);
    _getRentalAgentseendetails("12", widget.Rentalagentid.toString());
    print("RentalagentID-------------------${widget.Rentalagentid.toString()}");
  }
  ...
  void _getservicesdata(String Agentid) async {
    ...
    try {
      ...
      var fetchupdatedsdata =
          await fetchupdatlist.getFetchUserPostedLoanAgentt("3", Agentid);
  ...
  Future<String> _getRentalAgentseendetails(
    String actionId,
    String RentalAgentID,
  ) async {
    setState(() {
    ...
    try {
      var insertnotificationData = await insertdatanotification
          .getInsertDataNotification(actionId, RentalAgentID, "");
