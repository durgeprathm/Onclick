...
class UserPostedProjectTab extends StatefulWidget {
  @override
  _UserPostedProjectTabState createState() => _UserPostedProjectTabState();
}

class _UserPostedProjectTabState extends State<UserPostedProjectTab> {
  @override
        ...
        child: Column(
            ...
            children: <Widget>[
                      ...
                      Container(
                        child: Material(
                          ...
                          child: TabBar(
                            ...
                            tabs: [
                              Tab(text: 'Residental-Project [${Userpostedcountlist[0].ProjectResidentalCount}]'),
                              Tab(text: 'Commercial-Project [${Userpostedcountlist[0].ProjectCommericalCount}]'),
                            ],
                          ),
                        ),
                      ),
              ...
              Container(
                  ...
                  child: TabBarView(
                    children: <Widget>[
                      UserPostedCommonPropertyTabtabScreen(3,""),
                      UserPostedCommonPropertyTabtabScreen(4,""),
                    ],
                  )),
            ]));
  }
