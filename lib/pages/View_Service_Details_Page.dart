...
class ViewServiceDetailsPage extends StatefulWidget {
  ...
  String id;
  String checkid;
  ViewServiceDetailsPage(this.id, this.checkid);
...
class _ViewServiceDetailsPageState extends State<ViewServiceDetailsPage> {
  ...
  void initState() {
    ...
    _getserviceseendetails("8", widget.id.toString());
  }
  ...
  Future<String> _getserviceseendetails(
    String actionId,
    String ServiceID,
  ) async {
    setState(() {
    ...
    try {
      var insertnotificationData = await insertdatanotification
          .getInsertDataNotification(actionId, ServiceID, "");
